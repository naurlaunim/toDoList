		...
		return (
			<div>
				...
				<div className='wrapper'>
					...
					:	<span className="oi done header" data-glyph="calendar" title="done" aria-hidden="true"></span>
						{
							this.getList().map(task =>
								<div className='row' key={task.text.toString()} id={task.text.toString()}>
									...
									:	<span className="oi done" data-glyph="task" title="done" aria-hidden="true"></span>
									}
